/*10. Escriba un programa que permita mostrar los meses del año, pidiéndole al usuario
...
int main(){
	...
	cout<<"Introduzca un mes del año como numero (1-12): ";cin>>meses;
	...
	switch(meses){
		...
		default:cout<<"No existe un mes con esa numeracion"<<endl;break;
	}
